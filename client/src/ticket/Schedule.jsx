    ...
    return (
        <li>
            ...
            >
                ...
                >
                    {isStartStation ? 'From' : arriveTime}
                </span>
                <span
                ...
                >
                    {isEndStation ? 'To' : departTime}
                </span>
                <span className="stoptime">
                    {isStartStation || isEndStation ? '-' : stay + ' Minutes'}
                </span>
            </div>
        </li>
    );
        ...
        <div className="schedule">
            <div className="dialog">
                ...
                <div className="head">
                    ...
                    <span className="deptime">Arrival</span>
                    <span className="arrtime">Departure</span>
