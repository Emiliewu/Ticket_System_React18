...
const { appQueryJs, appTicketJs, appOrderJs } = require('./paths');
    ...
    plugins: [
      ...
      new WebpackManifestPlugin({
        ...
        generate: (seed, files, entrypoints) => {
          ...
          // the original entrypoints is an array, if we change the entry above to {}, it will return cannot filter error
          // const entrypointFiles = entrypoints.main.filter(
          //   fileName => !fileName.endsWith('.map')
          // );

          //so make some changes to realize the multiple entry files
          let entrypointFiles = [];
          ...
          // Iterate through all the entry files and then add them into entrypointFiles 
